...
class PrimaryRendererCuda : public RendererCuda
{
private:
...
public:
    PrimaryRendererCuda(const TriangleMeshCuda& mesh, IntersectorStreamCuda* intersector, int pixelCount, bool isFast = false);
    ~PrimaryRendererCuda();
