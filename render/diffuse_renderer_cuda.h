...
class DiffuseRendererCuda : public RendererCuda
{
private:
...
public:
    DiffuseRendererCuda(const TriangleMeshCuda& mesh, IntersectorStreamCuda* intersector, int pixelCount, int maxDepth, bool isFast = false);
    ~DiffuseRendererCuda();
