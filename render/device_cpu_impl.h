...
public:
    ...
    // FrameBuffer
    static void initFrame(DeviceCpuImpl* impl, const Vec2i& size);
    static void initToneMapper(DeviceCpuImpl* impl, const Props& props);
    static void clearFrame(DeviceCpuImpl* impl);
    static void updateFrame(DeviceCpuImpl* impl, Surface surface);
    static void readFrameHdr(DeviceCpuImpl* impl, Vec3f* dest);
};
